...
struct GasLedger {
    ...
    uint40 maxApprovedGasSpend; // Max gas units approved by current solver to be spent from their committed shMON
...
library GasAccLib {
    ...
    // subtracted at the start of its execution, before committed balance check.

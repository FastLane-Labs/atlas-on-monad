...
abstract contract ShMonadHolds is ShMonadStorage {
     ...
     * @dev Will revert if the account's committed value is insufficient to cover the hold
     */
     ...
     * @dev Will revert if any account's committed value is insufficient to cover its hold
     */
    function batchHold(
        uint64 policyID,

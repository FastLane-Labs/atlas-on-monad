...
uint256 constant SHMONAD_VALIDATOR_DEACTIVATION_PERIOD = 4; // How long it takes to cycle out an inactive validator
...
address constant LAST_VAL_ADDRESS = address(type(uint160).max);
address constant FIRST_VAL_ADDRESS = address(uint160(1));

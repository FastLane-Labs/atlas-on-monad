...
interface IMonadStaking {
    ...
    /// @notice Returns the validator ID of the current block author (producer)
    /// @dev This method is provided by the Monad staking precompile
    function getCurrentValidatorId() external returns (uint64 validatorId);

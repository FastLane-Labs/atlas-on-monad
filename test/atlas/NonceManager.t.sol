...
contract NonceManagerTest is AtlasVerificationBase {
    ...
    function test_NonceManager_getNextNonce_ReturnsOneForNewAccountSequential() public {
    ...
    function test_NonceManager_getNextNonce_ReturnsOneForNewAccountNonSeq() public {
    ...
    function test_NonceManager_usingSeqNonces_DoNotChangeNextNonSeqNonce() public {
        defaultAtlasWithCallConfig(defaultCallConfig().withUserNoncesSequential(true).build());
    ...
    function test_NonceManager_usingNonSeqNonces_DoNotChangeNextSeqNonce() public {
        defaultAtlasWithCallConfig(defaultCallConfig().withUserNoncesSequential(false).build());
        assertEq(atlasVerification.getUserNextNonce(userEOA, true), 1, "User next seq nonce should be 1");
        assertEq(atlasVerification.getUserNextNonce(userEOA, false), 1, "User next non-seq nonce should be 1");
    ...
    function test_NonceManager_sameNonce_CannotBeUsedTwiceUserSequential() public {
    ...
    function test_NonceManager_sameNonce_ValidForSeqAndNonSeqDApps() public {
    ...
    function test_NonceManager_seqNonces_MustBePerfectlySequential() public {
        defaultAtlasWithCallConfig(defaultCallConfig().withUserNoncesSequential(true).build());
    ...
    function test_NonceManager_nonSeqNonces_AreValidEvenIfNotSequential() public {
        defaultAtlasWithCallConfig(defaultCallConfig().withUserNoncesSequential(false).build());
    ...
    function test_NonceManager_firstEightNonces_DAppSequential() public {
    ...
    function test_NonceManager_getNextNonceAfter() public {
    ...
    function test_NonceManager_multipleGetNextNonceAfter() public {
    ...
    function test_NonceManager_handleSequentialNonces() public view {
        bool valid;
    ...
    function test_NonceManager_handleNonSequentialNonces() public view {
        bool valid;
    ...
    function test_NonceManager_handleUserSequentialNonces() public {
    ...
    function test_NonceManager_handleDAppSequentialNonces() public {
        // Last used nonce is 0 (never used yet)
    ...
    function test_NonceManager_handleUserNonSequentialNonces() public {

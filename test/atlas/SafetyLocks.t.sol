...
contract MockSafetyLocks is SafetyLocks {
    ...
    function initializeLock(address executionEnvironment, uint256, uint256) external payable {
...
contract SafetyLocksTest is Test {
    ...
    function test_SafetyLocks_setEnvironmentLock() public {
    ...
    function test_SafetyLocks_buildContext() public {
    ...
    function test_SafetyLocks_setLockPhase() public {
    ...
    function test_SafetyLocks_isUnlocked() public {
        safetyLocks.setLock(address(2));
    ...
    function test_SafetyLocks_combinedOperations() public {

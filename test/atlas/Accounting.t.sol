...
contract AccountingTest is BaseTest, AtlasConstants {
    ...
    function test_Accounting_solverBorrowRepaySuccessfully() public {
    ...
    function test_Accounting_solverBorrowWithoutRepayingReverts() public {
    ...
    function test_Accounting_accountingSolverDemonstration() public {
    ...
    function _buildUserOp() internal view returns (UserOperation memory userOp) {
    ...
    ) internal view returns (SolverOperation memory solverOp) {
    ...
    ) internal view returns (DAppOperation memory dAppOp) {

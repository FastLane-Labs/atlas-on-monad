...
contract AccountingMathTest is Test {
    ...
    function test_AccountingMath_withSurcharge() public pure {
    ...
    function test_AccountingMath_withoutSurcharge() public pure {
        // Test with 0% surcharge
    ...
    function test_AccountingMath_withSurcharges() public pure {
    ...
    function test_AccountingMath_getSurcharge() public pure {
        // Test with 0% surcharge
    ...
    function test_AccountingMath_maxBundlerRefund() public pure {
    ...
    function testFuzz_AccountingMath_withSurchargeInversewithoutSurcharge(uint256 amount, uint256 surchargeRate) public pure {
    ...
    function testFuzz_AccountingMath_withSurchargesCumulative(
        uint256 amount,
    ...
    function testFuzz_AccountingMath_getSurchargeConsistency(uint256 amount, uint256 surchargeRate) public pure {
        // Bound inputs
        amount = bound(amount, 1, 1e36);
        surchargeRate = bound(surchargeRate, 0, SCALE); // 0% to 100%
    ...
    function testFuzz_AccountingMath_maxBundlerRefund(uint256 gasCost) public pure {
    ...
    function test_AccountingMath_edgeCases() public pure {
    ...
    function test_AccountingMath_gasConstants() public pure {

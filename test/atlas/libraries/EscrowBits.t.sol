...
contract EscrowBitsTest is Test {
    ...
    function test_EscrowBits_constants() public pure {
    ...
    function test_EscrowBits_canExecute() public pure {
        uint256 valid = 0;
    ...
    function test_EscrowBits_executionSuccessful() public pure {
        uint256 valid = 0;
    ...
    function test_EscrowBits_executedWithError() public pure {
        // FULL REFUND group
    ...
    function test_EscrowBits_bundlersFault() public pure {
        // SUCCESS
        uint256 invalid = 0;

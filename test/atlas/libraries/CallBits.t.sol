...
contract CallBitsTest is Test {
    ...
    function test_CallBits_encodeCallConfig() public view {
    ...
    function test_CallBits_decodeCallConfig() public view {
    ...
    function test_CallBits_configParameters() public view {
        uint32 encodedCallConfig = CallBits.encodeCallConfig(callConfig1);

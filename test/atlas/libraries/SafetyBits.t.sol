...
contract SafetyBitsTest is Test {
    ...
    function test_SafetyBits_escrowBitsConstants() public pure {
    ...
    function test_SafetyBits_setAndPackDefaultContext() public pure {
        Context memory ctx;
    ...
    function test_SafetyBits_setAndPackWithValues() public pure {
    ...
    function test_SafetyBits_setAndPackAllPhases() public pure {
        Context memory ctx;
    ...
    function testFuzz_SafetyBits_setAndPack(
        address bundler,
    ...
    function test_SafetyBits_phaseTransitions() public pure {
        Context memory ctx;
    ...
    function test_SafetyBits_safeTransferBitmasks() public pure {

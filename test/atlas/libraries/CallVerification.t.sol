...
contract CallVerificationTest is Test {
    function test_CallVerification_getCallChainHash_EmptyOperations() public pure {
    ...
    function test_CallVerification_getCallChainHash_WithUserOp() public pure {
    ...
    function test_CallVerification_getCallChainHash_WithSolverOps() public pure {
        UserOperation memory userOp = UserOperation({
            from: address(0x1111111111111111111111111111111111111111),
            to: address(0x2222222222222222222222222222222222222222),
            value: 1 ether,
    ...
    function test_CallVerification_getCallChainHash_OrderMatters() public pure {
        UserOperation memory userOp;
    ...
    function testFuzz_CallVerification_getCallChainHash(
        address userFrom,
        address userTo,
        uint256 userValue,
    ...
    function test_CallVerification_getCallChainHash_GasEfficiency() public pure {
        UserOperation memory userOp = UserOperation({
            from: address(0x1111),
            to: address(0x2222),
            value: 1 ether,
        ...
        for (uint i = 0; i <= 5; i++) {
            ...
            // Just verify we get a hash
            assertTrue(hash != bytes32(0), "Should produce non-zero hash");
        }
    }

    function test_CallVerification_getCallChainHash_EdgeCases() public pure {

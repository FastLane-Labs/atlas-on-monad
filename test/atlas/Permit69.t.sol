...
contract Permit69Test is AtlasBaseTest {
    ...
    function test_Permit69_transfer_UserERC20RevertsIfCallerNotExecutionEnv() public {
    ...
    function test_Permit69_transfer_UserERC20RevertsIfEnvironmentMismatch() public {
        // Set active ExecutionEnvironment in Atlas
        TestAtlas(payable(address(atlas))).setLock(executionEnvironment, 0, uint8(ExecutionPhase.PreOps));
    ...
    function test_Permit69_transfer_UserERC20RevertsIfLockStateNotValid() public {
    ...
    function test_Permit69_transfer_UserERC20SuccessfullyTransfersTokens() public {
        // Set active ExecutionEnvironment in Atlas
        TestAtlas(payable(address(atlas))).setLock(executionEnvironment, 0, uint8(ExecutionPhase.PreOps));
    ...
    function test_Permit69_transfer_DAppERC20RevertsIfCallerNotExecutionEnv() public {
        // Set active ExecutionEnvironment in Atlas
        TestAtlas(payable(address(atlas))).setLock(executionEnvironment, 0, uint8(ExecutionPhase.PreOps));
    ...
    function test_Permit69_transfer_DAppERC20RevertsIfEnvironmentMismatch() public {
        // Set active ExecutionEnvironment in Atlas
        TestAtlas(payable(address(atlas))).setLock(executionEnvironment, 0, uint8(ExecutionPhase.PreOps));
    ...
    function test_Permit69_transfer_DAppERC20RevertsIfLockStateNotValid() public {
    ...
    function test_Permit69_transfer_DAppERC20SuccessfullyTransfersTokens() public {
        // Set active ExecutionEnvironment in Atlas
        TestAtlas(payable(address(atlas))).setLock(executionEnvironment, 0, uint8(ExecutionPhase.PreOps));
    ...
    // constants tests
    function test_Permit69_constantValueOfSafeUserTransfer() public pure {
    ...
    function test_Permit69_constantValueOfSafeDAppTransfer() public pure {

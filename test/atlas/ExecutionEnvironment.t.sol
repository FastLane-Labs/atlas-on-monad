...
contract ExecutionEnvironmentTest is AtlasBaseTest {
    ...
    function setUp() public override {
        ...
        // These are unit tests - always use mock token
        testToken = new MockERC20("Wrapped MON", "WMON");
        WMON_ADDRESS = address(testToken);
    ...
    function test_ExecutionEnvironment_validUser_SkipCoverage() public {
    ...
    function test_ExecutionEnvironment_onlyAtlasEnvironment_SkipCoverage() public {
        UserOperation memory userOp;
        bytes memory preOpsData;
        bool status;
    ...
    function test_ExecutionEnvironment_validControlHash_SkipCoverage() public {
        UserOperation memory userOp;
    ...
    function test_ExecutionEnvironment_preOpsWrapper_SkipCoverage() public {
        UserOperation memory userOp;
        bytes memory preOpsData;
        bool status;
        bytes memory data;
    ...
    function test_ExecutionEnvironment_userWrapper_SkipCoverage() public {
        UserOperation memory userOp;
        bytes memory userData;
        bool status;
        bytes memory data;
    ...
    function test_ExecutionEnvironment_solverPreTryCatch_SkipCoverage() public {
    ...
    function test_ExecutionEnvironment_solverPostTryCatch_SkipCoverage() public {
    ...
    function test_ExecutionEnvironment_allocateValue_SkipCoverage() public {
    ...
    function test_ExecutionEnvironment_withdrawERC20_SkipCoverage() public {
        // Valid
    ...
    function test_ExecutionEnvironment_withdrawEther_SkipCoverage() public {
        // Valid
    ...
    function test_ExecutionEnvironment_getUser_SkipCoverage() public view {
        assertEq(executionEnvironment.getUser(), testUser);
    }

    function test_ExecutionEnvironment_getControl_SkipCoverage() public view {
        assertEq(executionEnvironment.getControl(), address(dAppControl));
    }

    function test_ExecutionEnvironment_getConfig_SkipCoverage() public view {
        assertEq(executionEnvironment.getConfig(), CallBits.encodeCallConfig(callConfig));
    }

    function test_ExecutionEnvironment_getEscrow_SkipCoverage() public view {
        assertEq(executionEnvironment.getEscrow(), address(atlas));
    }

    // Test withdraw functions - these test different scenarios from the main test above

    function test_ExecutionEnvironment_withdrawERC20_NotOwner_SkipCoverage() public {
        deal(WMON_ADDRESS, address(executionEnvironment), 2e18);
    ...
    function test_ExecutionEnvironment_withdrawERC20_InsufficientBalance_SkipCoverage() public {
        vm.prank(testUser);
        vm.expectRevert(AtlasErrors.ExecutionEnvironmentBalanceTooLow.selector);
        executionEnvironment.withdrawERC20(WMON_ADDRESS, 1e18);
    }

    function test_ExecutionEnvironment_withdrawEther_NotOwner_SkipCoverage() public {
        deal(address(executionEnvironment), 2e18);
    ...
    function test_ExecutionEnvironment_withdrawEther_InsufficientBalance_SkipCoverage() public {
        vm.prank(testUser);
        vm.expectRevert(AtlasErrors.ExecutionEnvironmentBalanceTooLow.selector);
    ...
    // ============================================
    // Simple ExecutionEnvironment Tests
    // ============================================
    // These are simplified tests that work with the Mimic proxy
    
    function test_ExecutionEnvironment_withdrawERC20_SimpleFlow_SkipCoverage() public {
        // Give EE some WMON
        deal(WMON_ADDRESS, address(executionEnvironment), 2e18);
        assertEq(WMON.balanceOf(address(executionEnvironment)), 2e18);
        assertEq(WMON.balanceOf(testUser), 0);
        
        // Atlas should already be unlocked by default (transient storage starts at 0)
    ...
    function test_ExecutionEnvironment_withdrawEther_SimpleFlow_SkipCoverage() public {
        // Give EE some ETH
        deal(address(executionEnvironment), 2e18);
        assertEq(address(executionEnvironment).balance, 2e18);
...
contract MockDAppControl is DAppControl {
    ...
    function _allocateValueCall(bool, address, uint256, bytes calldata data) internal virtual override {

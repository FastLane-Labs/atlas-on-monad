...
contract AtlasVerificationBase is BaseTest {
    ...
    function validDAppOperation(DAppConfig memory, UserOperation memory userOp, SolverOperation[] memory solverOps) public returns (DAppOperationBuilder) {
...
contract AtlasVerificationVerifySolverOpTest is AtlasVerificationBase {
    ...
    function test_AtlasVerification_verifySolverOp_InvalidSignature() public {
    ...
    function test_AtlasVerification_verifySolverOp_InvalidUserHash() public {
        UserOperation memory userOp = validUserOperation().build();
        SolverOperation[] memory solverOps = validSolverOperations(userOp);
    ...
    function test_AtlasVerification_verifySolverOp_InvalidTo() public {
        UserOperation memory userOp = validUserOperation().build();
        SolverOperation[] memory solverOps = validSolverOperations(userOp);
        address bundler = solverOneEOA;
    ...
    function test_AtlasVerification_verifySolverOp_GasPriceOverCap() public {
        UserOperation memory userOp = validUserOperation().build();
        SolverOperation[] memory solverOps = validSolverOperations(userOp);
        address bundler = solverOneEOA;
    ...
    function test_AtlasVerification_verifySolverOp_GasPriceBelowUsers() public {
        UserOperation memory userOp = validUserOperation().build();
        SolverOperation[] memory solverOps = validSolverOperations(userOp);
        address bundler = solverOneEOA;
    ...
    function test_AtlasVerification_verifySolverOp_InvalidSolver() public {
        UserOperation memory userOp = validUserOperation().build();
        SolverOperation[] memory solverOps = validSolverOperations(userOp);
        address bundler = solverOneEOA;
    ...
    function test_AtlasVerification_verifySolverOp_Valid() public {
        UserOperation memory userOp = validUserOperation().build();
        SolverOperation[] memory solverOps = validSolverOperations(userOp);
        address bundler = solverOneEOA;
...
contract AtlasVerificationValidCallsTest is AtlasVerificationBase {
    ...
    function test_AtlasVerification_defaultEverything_Valid() public {
    ...
    //
    function test_AtlasVerification_verifyUserOp_UserSignatureInvalid() public {
        defaultAtlasEnvironment();
    ...
    //
    function test_AtlasVerification_verifyUserOp_ValidWhenUserBundler() public {
        defaultAtlasEnvironment();
    ...
    //
    function test_AtlasVerification_verifyUserOp_ValidInSimulation() public {
        defaultAtlasEnvironment();
    ...
    // because the user operation doesn't need to be signed if it's a simulation
    //
    function test_AtlasVerification_verifyUserOp_ValidBadSigInSimulation() public {
        defaultAtlasEnvironment();
    ...
    //
    function test_AtlasVerification_verifyUserOp_UserFromInvalid() public {
        defaultAtlasEnvironment();
    ...
    function test_AtlasVerification_validCalls_CheckMetacallGasLimitEnabledGasLimitTooLow() public {
    ...
    function test_AtlasVerification_validCalls_CheckMetacallGasLimitEnabledGasLimitTooHigh() public {
        defaultAtlasWithCallConfig(defaultCallConfig().withCheckMetacallGasLimit(true).build());
    ...
    function test_AtlasVerification_validCalls_CheckMetacallGasLimitDisabledLowGasLimitValid() public {
    ...
    function test_AtlasVerification_validCalls_CheckMetacallGasLimitDisabledHighGasLimitValid() public {
        defaultAtlasWithCallConfig(defaultCallConfig().withCheckMetacallGasLimit(false).build());
    ...
    function test_AtlasVerification_getDomainSeparator() public view {
